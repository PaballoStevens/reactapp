    ...
    <div className="panel messages-panel">
        <div className="contacts-list">
            <div className="inbox-categories">
                <div data-toggle="tab" data-target="#inbox" className="active"> Inbox </div>
                ...
                <div id="inbox" className="contacts-outter-wrapper tab-pane active">
                    ...
                    <div className="contacts-outter">
                        <ul className="list-unstyled contacts">
                            <li data-toggle="tab" data-target="#inbox-message-1" className="active">
                            ...
                            <li data-toggle="tab" data-target="#inbox-message-2">
                                ...
                                <div className="contacts-add">
                                    <span className="message-time"> 3:56 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                            <li data-toggle="tab" data-target="#inbox-message-3">
                                ...
                                <div className="contacts-add">
                                    <span className="message-time"> 5:21 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                            <li data-toggle="tab" data-target="#inbox-message-4">
                                ...
                                <div className="contacts-add">
                                    <span className="message-time"> 6:13 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                    ...
                    <div className="contacts-outter">
                        <ul className="list-unstyled contacts success">
                            <li data-toggle="tab" data-target="#sent-message-1">
                                ...
                                <div className="contacts-add">
                                    <span className="message-time"> 2:24 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                            <li data-toggle="tab" data-target="#sent-message-2">
                                ...
                                <div className="vcentered info-combo">
                                    <h3 className="no-margin-bottom name"> Jeff Williams </h3>
                                    <h5> Hello, Dennis. I will take a look at it tomorrow, because I'm </h5>
                                </div>
                                <div className="contacts-add">
                                    <span className="message-time"> 12:41 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                    ...
                    <div className="contacts-outter">
                        <ul className="list-unstyled contacts warning">
                            <li data-toggle="tab" data-target="#marked-message-1">
                                ...
                                <div className="vcentered info-combo">
                                    <h3 className="no-margin-bottom name"> Jessica Franco </h3>
                                    <h5> Hello, Dennis. I wanted to let you know we reviewed your proposal and decided  </h5>
                                </div>
                                <div className="contacts-add">
                                    <span className="message-time"> 1:44 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                            <li data-toggle="tab" data-target="#marked-message-2">
                                ...
                                <div className="contacts-add">
                                    <span className="message-time"> 3:23 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
                    ...
                    <div className="contacts-outter">
                        <ul className="list-unstyled contacts dark">
                            <li data-toggle="tab" data-target="#draft-message-1">
                                ...
                                <div className="vcentered info-combo">
                                    <h3 className="no-margin-bottom name"> Milla Shiffman </h3>
                                    <h5> Hello, Mila, can you send me the latest pack of icons, I need </h5>
                                </div>
                                <div className="contacts-add">
                                    <span className="message-time"> 4:22 <sup>AM</sup></span>
                                    <i className="fa fa-trash-o"></i>
                                    <i className="fa fa-paperclip"></i>
                                </div>
                            </li>
        ...
        <div className="tab-content">
            <div className="tab-pane message-body active" id="inbox-message-1">
                <div className="message-top">
                    <a className="btn btn btn-success new-message"> <i className="fa fa-envelope"></i> New Message </a>

                    <div className="new-message-wrapper">
                        <div className="form-group">
                            <input type="text" className="form-control" placeholder="Send message to..."/>
                            <a className="btn btn-danger close-new-message" href="#"><i className="fa fa-times"></i></a>
                        </div>
                    ...
                    <div className="chat-body">
                        ...
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Elon Musk </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 2:32 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                    ...
                    <div className="chat-body">
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    ...
                                    <h5> <i className="fa fa-clock-o"></i> 3:45 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 3:52 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                        ...
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Mark Zuckerberg </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 3:56 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 4:01 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                                        Great, thank you.
                    ...
                    <div className="chat-body">
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Evan Williams </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 5:07 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 5:16 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                        ...
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Evan Williams </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 5:21 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                    ...
                    <div className="chat-body">
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Jonahtan Ive </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 6:12 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 6:16 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                        ...
                        <div className="message info">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Jonahtan Ive </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 6:13 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                    ...
                    <div className="chat-body">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 2:05 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                        ...
                        <div className="message success">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> David Beckham </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 2:11 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message success">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> David Beckham </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 2:24 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                    ...
                    <div className="chat-body">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 12:36 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                        ...
                        <div className="message success">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Jeff Williams </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 12:41 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 12:46 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                                        Thanks :)
                        ...
                        <div className="message warning">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    ...
                                    <h5> <i className="fa fa-clock-o"></i> 1:44 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 1:51 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                    ...
                    <div className="chat-body">
                        <div className="message warning">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Pavel Durov </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 3:23 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 3:31 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
                        ...
                        <div className="message warning">
                            ...
                            <div className="message-body">
                                <div className="message-info">
                                    <h4> Pavel Durov </h4>
                                    <h5> <i className="fa fa-clock-o"></i> 3:35 PM </h5>
                                </div>
                                <hr/>
                                <div className="message-text">
                        ...
                        <div className="message my-message">
                            ...
                            <div className="message-body">
                                <div className="message-body-inner">
                                    <div className="message-info">
                                        <h4> Dennis Novac </h4>
                                        <h5> <i className="fa fa-clock-o"></i> 4:22 PM </h5>
                                    </div>
                                    <hr/>
                                    <div className="message-text">
